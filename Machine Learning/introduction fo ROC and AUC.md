# ROC和AUC介绍
*Clement Edit, 2016.9.27*
**摘自博客http://alexkong.net/2013/06/introduction-to-auc-and-roc/**
...
1.	避免将precision，recall等评价指标翻译成中文，因为它们可能对应多个中文解释，极易产生混淆。
